...
/// </summary>
public class TeamBasedOrderSeederFixed
{
    private readonly IDatabaseService _databaseService;
    private readonly ILogger<TeamBasedOrderSeederFixed> _logger;

    public TeamBasedOrderSeederFixed(IDatabaseService databaseService, ILogger<TeamBasedOrderSeederFixed> logger)
    {
